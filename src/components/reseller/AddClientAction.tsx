  ...
  return (
    <>
      ...
      <div
        ...
        className="hidden sm:flex w-full p-4 mb-8 items-center justify-between cursor-pointer group backdrop-blur-md bg-white/[0.02] border border-white/10 rounded-2xl transition-all duration-300 hover:border-[#00e5ff] hover:shadow-[0_0_25px_rgba(0,229,255,0.4)] overflow-hidden"
      ...
      {/* Floating Action Button (FAB) - AI Universal Command - Shows on both desktop and mobile */}
      <div
        onClick={() => setShowModal(true)}
